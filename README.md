...
> Go AST-based codebase intelligence and diagram-to-IaC scaffold generator  
...
[`github.com/gin-gonic/gin`](https://github.com/gin-gonic/gin) — used as the open-source Go codebase for parser evaluation.

## Project structure
```
design-to-code/
├── cmd/
│   └── graphparser/       # CLI entry point
├── internal/
│   └── graph/             # AST parser, data model, query API
├── corpus/                # gin source (evaluation corpus)
└── go.mod
```
